<template>
  ...
  >
    ...
    ></path>
    <path d="M2.3999 15.8059L7.63636 21.0424" stroke="#000929" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
    <path d="M16.3635 21.0424L21.6 15.8059" stroke="#000929" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
  </svg>
</template>